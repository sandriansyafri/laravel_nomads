        ...
        <div class="section-popular-travel row justify-content-center">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div
              ...
              style="background-image: url('{{ $travel_package->gallery->count() ? Storage::url($travel_package->gallery->first()->image) : ''  }}');"
            >
              <div class="travel-country text-uppercase">{{ $travel_package->location }}</div>
              <div class="travel-location text-uppercase">{{ $travel_package->title }}</div>
